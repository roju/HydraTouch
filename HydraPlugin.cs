/* 
 * Modified HydraPlugin.cs from FreePIE
...
namespace HydraTouch {
   ...
   public class HydraPluginGlobal {
      ...
      public bool docked {
          get {
              return (Hydra.Controller[Index].is_docked) != 0;
          }
      }
      ...
      public float m00
      {
          get
          {
              return Hydra.Controller[Index].rot_mat_00;
          }
      }
      ...
      public float m01
      {
          get
          {
              return Hydra.Controller[Index].rot_mat_01;
          }
      }
      ...
      public float m02
      {
          get
          {
              return Hydra.Controller[Index].rot_mat_02;
          }
      }
      ...
      public float m10
      {
          get
          {
              return Hydra.Controller[Index].rot_mat_10;
          }
      }
      ...
      public float m11
      {
          get
          {
              return Hydra.Controller[Index].rot_mat_11;
          }
      }
      ...
      public float m12
      {
          get
          {
              return Hydra.Controller[Index].rot_mat_12;
          }
      }
      ...
      public float m20
      {
          get
          {
              return Hydra.Controller[Index].rot_mat_20;
          }
      }
      ...
      public float m21
      {
          get
          {
              return Hydra.Controller[Index].rot_mat_21;
          }
      }
      ...
      public float m22
      {
          get
          {
              return Hydra.Controller[Index].rot_mat_22;
          }
      }
   }
}
