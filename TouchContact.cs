...
{
    public class TouchContact// : INotifyPropertyChanged
    {
        ...
        /// 
        public TouchContact(int posX, int posY, int iID) //Point tPosition, ContactType eContactType
        {
        ...
        //public bool JustDocked { get; set; }

        //public bool JustUndocked { get; set; }
